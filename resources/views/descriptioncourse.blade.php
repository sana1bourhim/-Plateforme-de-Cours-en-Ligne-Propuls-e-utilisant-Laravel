...
<nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto p-4 p-lg-0">
            <a href="{{ route('homeStudent') }}" class="nav-item nav-link active">Home</a>
        ...
        <a href="{{url('/viewdidac', $didacticiel->id)}}" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block">Apply Now<i class="fa fa-arrow-right ms-3"></i></a>
    </div>
</nav>
    <!-- Carousel Start -->
    <div class="container-fluid p-0 mb-5">
        <div class="owl-carousel header-carousel">
            <div class=" ">
                <img class="img-fluid" src="{{asset('assets/img/image_elarning.jpg')}}" alt="">
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(24, 29, 56, .7);">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                <h5 class="text-primary text-uppercase mb-3 animated slideInDown">category Name</h5>
                                <h1 class="display-3 text-white animated slideInDown">{{ $didacticiel->titre }} </h1>
                                <p class="fs-5 text-white mb-4 pb-2"></p>
                                
                                
                                <a href="{{url('/viewdidac', $didacticiel->id)}}" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Apply Now</a>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-100 h-100" src="{{asset('assets/img/iStock-1169929038.jpg')}}" alt="" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <h6 class="section-title bg-white text-start text-primary pe-3">About Course</h6>
                    <h1 class="mb-4">{{ $didacticiel->titre }}</h1>
                    <p class="mb-4">
                    ...
                    <div class="row gy-2 gx-4 mb-4">
                        @foreach($chapters as $chapter)
                            <div class="col-sm-6">
                                <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Chapter {{ $chapter->ordre }} - {{ $chapter->titre }}</p>
                            </div>
                        @endforeach
                    </div>
                    <a class="btn btn-primary py-3 px-5 mt-2" href="{{url('/viewdidac', $didacticiel->id)}}">Read More</a>
                </div>
            </div>
        </div>
    </div>
