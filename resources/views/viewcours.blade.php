        ...
        <header class="topbar" data-navbarbg="skin5">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand" onclick="window.history.back();" href="#">
                ...
                <div class="scroll-sidebar">
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            ...
                            <li class="text-lg ml-3 font-medium text-black pt-2">
                                <span class="hide-menu sidebar-link waves-effect waves-dark sidebar-link ">
                                    @php
                                    ...
                                    if ($elements) {
                                        ...
                                        if ($section) {
                                            ...
                                            if ($chapitre) {
                                                $didacticiel = App\Models\Didacticiel::find($chapitre->didacticiel_id); // Récupérez le didacticiel correspondant
                            
                                                // Affichez le titre du didacticiel


                                                echo '<h2>' . $didacticiel->titre . '</h2>';
                            ...
                            <li class="sidebar-item border border-black ">

                                <a class="sidebar-link waves-effect waves-dark sidebar-link" href="#" aria-expanded="false">
                                    <span class="hide-menu chapter" >
                                        @php
                                    $elements = App\Models\Element::where('id_cours', $co->ID_cours)->first();
                                    if ($elements) {
                                        $section = App\Models\Section::find($elements->id_section);
                                        if ($section) {
                                            ...
                                            if ($chapitre) {
                                                $didacticiel = App\Models\Didacticiel::find($chapitre->didacticiel_id); // Récupérez le didacticiel correspondant
                                                $didacticiel = App\Models\Didacticiel::find($chapitre->didacticiel_id);
                                                ...
                                                foreach ($chapitres as $chapitre) {
                                                    ...
                                                    echo '<span class="text-lg font-bold">Chapitre '.$chapitre->ordre .':</span>';
                                                    echo '<span class="text-xs"> <br>'.$chapitre->titre . '</br></span>';
...
foreach ($cours as $cour) {
    ...
    if ($course) {
        echo '<div class=" ml-3 "><a href="/viewcours/'. $course->ID_cours . '"> Course'.$course->ID_cours.': '. $course->titre . '<br> </a></div>';
}                                                           
}
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <span class=" text-2xl font-medium">{{ $co->titre }}</span>
                    </div>
            ...
            <div class="mt-6 ml-10">
                <span class="text-md font-medium ">Course Description :</span>
                <p class="text-sm text-black mt-3 mr-3 ">@php
                    $elements = App\Models\Element::where('id_cours', $co->ID_cours)->first();
                    if ($elements) {
                        $course = App\Models\Cours::find($elements->id_cours);
                    
                        if ($course) {
                            echo '<h6>' . $course->description . '</h6>';
                        }
                    }
                    @endphp
                                    </p>
